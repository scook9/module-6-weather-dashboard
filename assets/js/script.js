...
// jquery declares ajax as a function and executes the response from the url call only once
$.ajax({
  url: requestUrl,
  method: 'GET',
...
//fetches variable which has url value, .then creates creates a promise object that is a function
fetch(requestUrl)
  .then(function (response) {
